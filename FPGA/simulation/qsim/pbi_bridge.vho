...
-- Equation(s):
-- \u1|master_wren~0_combout\ = (\u1|bit_cnt\(5) & ((\u1|bit_cnt\(3)) # (\u1|bit_cnt\(4))))
...
-- Equation(s):
-- \u1|slave_rden~0_combout\ = (\u1|bit_cnt\(6)) # ((\u1|bit_cnt\(7)) # ((\u1|bit_cnt\(8)) # (\u1|master_wren~0_combout\)))
...
PORT MAP (
	...
	datab => \u1|bit_cnt\(7),
	datac => \u1|bit_cnt\(8),
	datad => \u1|master_wren~0_combout\,
...
-- Equation(s):
-- \u1|process_1~2_combout\ = (\u1|process_1~0_combout\) # ((\u1|LessThan0~0_combout\ & ((!\u1|bit_cnt\(4)) # (!\u1|bit_cnt\(3)))))
...
-- Equation(s):
-- \Equal11~4_combout\ = (\Equal11~3_combout\ & !\addr[11]~input_o\)
...
-- Equation(s):
-- \Equal11~5_combout\ = (\Equal11~4_combout\ & (\Equal11~2_combout\ & (!\addr[9]~input_o\ & !\addr[10]~input_o\)))
...
-- Equation(s):
-- \dev_reg_act~2_combout\ = (\addr[8]~input_o\ & (!\addr[9]~input_o\ & (!\addr[10]~input_o\ & !\Equal11~2_combout\)))
...
-- Equation(s):
-- \dev_reg_act~3_combout\ = (\Equal11~3_combout\ & (!\addr[11]~input_o\ & \dev_reg_act~2_combout\))
...
-- Equation(s):
-- \reg_sdcr[0]~0_combout\ = (\dev_reg_act~q\ & (!\slave_ram_en~q\ & !\master_ram_en~q\))
...
-- Equation(s):
-- \reg_sdcr[0]~1_combout\ = (\Equal10~5_combout\ & (\reg_sdcr[0]~0_combout\ & (!\rw_latch~q\ & !\hw_sel_act~q\)))
...
-- Equation(s):
-- \led_latch[0]~1_combout\ = (\Equal13~0_combout\ & (\Equal13~1_combout\ & (\Equal13~2_combout\ & !addr_latch(5))))
...
-- Equation(s):
-- \Equal19~0_combout\ = (\led_latch[0]~1_combout\ & (addr_latch(1) & (addr_latch(4) & !addr_latch(0))))
...
-- Equation(s):
-- \reg_srbs[0]~0_combout\ = (\reg_sdcr[0]~1_combout\ & \Equal19~0_combout\)
...
-- Equation(s):
-- \u1|process_1~1_combout\ = (\u1|bit_cnt\(6)) # ((\u1|bit_cnt\(7)) # ((\u1|bit_cnt\(8)) # (!\u1|bit_cnt\(5))))
...
-- Equation(s):
-- \u1|s_rd_bank[0]~0_combout\ = (\u1|rx_buf[7]~16_combout\ & (!\u1|bit_cnt\(3) & (!\u1|bit_cnt\(4) & !\u1|process_1~1_combout\)))
...
-- Equation(s):
-- \u1|s_rd_bank[5]~1_combout\ = (\u1|bit_cnt\(0) & (\u1|bit_cnt\(2) & (\u1|s_rd_bank[0]~0_combout\ & !\u1|bit_cnt\(1))))
...
PORT MAP (
	dataa => \u1|bit_cnt\(0),
	datab => \u1|bit_cnt\(2),
	datac => \u1|s_rd_bank[0]~0_combout\,
	datad => \u1|bit_cnt\(1),
...
PORT MAP (
	...
	datab => \u1|s_rd_bank\(5),
	datad => \u1|s_rd_bank[5]~1_combout\,
...
-- Equation(s):
-- \u1|dpram_slave|altsyncram_component|auto_generated|rden_decode_a|eq_node[0]~0_combout\ = (!\u1|s_rd_bank\(5) & ((\u1|master_wren~q\) # (\u1|dpram_slave|altsyncram_component|auto_generated|rden_a_store~q\)))
...
-- Equation(s):
-- \u1|process_1~3_combout\ = (\u1|master_ram_clk~1_combout\ & (((\u1|bit_cnt\(3) & \u1|bit_cnt\(4))) # (!\u1|LessThan0~0_combout\)))
...
-- Equation(s):
-- \u1|slave_ram_clk~0_combout\ = (!\u1|bit_cnt\(1) & (!\u1|bit_cnt\(0) & !\u1|bit_cnt\(2)))
...
-- Equation(s):
-- \u1|s_rd_bank[0]~3_combout\ = (\u1|slave_ram_clk~0_combout\ & ((\u1|s_rd_bank[0]~0_combout\ & (\spi_mosi~input_o\)) # (!\u1|s_rd_bank[0]~0_combout\ & ((\u1|s_rd_bank\(0)))))) # (!\u1|slave_ram_clk~0_combout\ & (((\u1|s_rd_bank\(0)))))
...
-- Equation(s):
-- \u1|s_rd_bank[1]~4_combout\ = (\u1|bit_cnt\(0) & (\u1|s_rd_bank[0]~0_combout\ & (!\u1|bit_cnt\(1) & !\u1|bit_cnt\(2))))
...
PORT MAP (
	dataa => \u1|bit_cnt\(0),
	datab => \u1|s_rd_bank[0]~0_combout\,
	datac => \u1|bit_cnt\(1),
	datad => \u1|bit_cnt\(2),
...
-- Equation(s):
-- \u1|s_wr_bank[2]~6_combout\ = (\u1|bit_cnt\(1) & (!\u1|bit_cnt\(0) & !\u1|bit_cnt\(2)))
...
-- Equation(s):
-- \u1|s_rd_bank[2]~6_combout\ = (\u1|s_wr_bank[2]~6_combout\ & ((\u1|s_rd_bank[0]~0_combout\ & (\spi_mosi~input_o\)) # (!\u1|s_rd_bank[0]~0_combout\ & ((\u1|s_rd_bank\(2)))))) # (!\u1|s_wr_bank[2]~6_combout\ & (((\u1|s_rd_bank\(2)))))
...
PORT MAP (
	dataa => \spi_mosi~input_o\,
	datab => \u1|s_rd_bank\(2),
	datac => \u1|s_wr_bank[2]~6_combout\,
	datad => \u1|s_rd_bank[0]~0_combout\,
...
-- Equation(s):
-- \u1|s_wr_bank[3]~8_combout\ = (\u1|bit_cnt\(1) & (\u1|bit_cnt\(0) & !\u1|bit_cnt\(2)))
...
-- Equation(s):
-- \u1|s_rd_bank[3]~7_combout\ = (\u1|s_wr_bank[3]~8_combout\ & ((\u1|s_rd_bank[0]~0_combout\ & (\spi_mosi~input_o\)) # (!\u1|s_rd_bank[0]~0_combout\ & ((\u1|s_rd_bank\(3)))))) # (!\u1|s_wr_bank[3]~8_combout\ & (((\u1|s_rd_bank\(3)))))
...
PORT MAP (
	dataa => \spi_mosi~input_o\,
	datab => \u1|s_rd_bank\(3),
	datac => \u1|s_wr_bank[3]~8_combout\,
	datad => \u1|s_rd_bank[0]~0_combout\,
...
-- Equation(s):
-- \u1|s_rd_bank[4]~8_combout\ = (\u1|bit_cnt\(2) & (\u1|s_rd_bank[0]~0_combout\ & (!\u1|bit_cnt\(1) & !\u1|bit_cnt\(0))))
...
-- Equation(s):
-- \u1|tx_buf[7]~0_combout\ = (\u1|bit_cnt\(3) $ (!\u1|bit_cnt\(4))) # (!\u1|LessThan0~0_combout\)
...
-- Equation(s):
-- \Equal13~3_combout\ = (addr_latch(5) & (\Equal13~0_combout\ & (\Equal13~1_combout\ & \Equal13~2_combout\)))
...
-- Equation(s):
-- \reg_stbycr[0]~0_combout\ = (\reg_sdcr[0]~1_combout\ & (addr_latch(4) & (\Equal13~4_combout\ & !addr_latch(0))))
...
PORT MAP (
	clk => \u1|slave_ram_clk~combout\,
	d => \u1|dpram_slave|altsyncram_component|auto_generated|address_reg_a\(0),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \u1|tx_buf[7]~1_combout\ = (\u1|dpram_slave|altsyncram_component|auto_generated|out_address_reg_a\(0) & ((\u1|bit_cnt\(3)) # ((!\u1|bit_cnt\(4)) # (!\u1|LessThan0~0_combout\)))) # (!\u1|dpram_slave|altsyncram_component|auto_generated|out_address_reg_a\(0) 
-- & (\u1|bit_cnt\(3) & (\u1|LessThan0~0_combout\ & !\u1|bit_cnt\(4))))
...
-- Equation(s):
-- \reg_stbkcr[0]~0_combout\ = (\reg_sdcr[0]~1_combout\ & (addr_latch(4) & (\Equal13~3_combout\ & \Equal14~0_combout\)))
...
-- Equation(s):
-- \u1|tx_buf~2_combout\ = (\u1|tx_buf[7]~0_combout\ & (((\u1|tx_buf[7]~1_combout\)))) # (!\u1|tx_buf[7]~0_combout\ & ((\u1|tx_buf[7]~1_combout\ & (reg_stbycr(6))) # (!\u1|tx_buf[7]~1_combout\ & ((reg_stbkcr(6))))))
...
-- Equation(s):
-- \reg_sdcr[0]~2_combout\ = (\reg_sdcr[0]~1_combout\ & (addr_latch(4) & (addr_latch(0) & \Equal13~4_combout\)))
...
-- Equation(s):
-- \u1|LessThan2~0_combout\ = (\u1|bit_cnt\(3)) # ((\u1|bit_cnt\(4)) # (!\u1|LessThan0~0_combout\))
...
-- Equation(s):
-- \u1|tx_buf[7]~4_combout\ = (\u1|bit_cnt\(3) & (((!\u1|LessThan0~0_combout\) # (!\u1|bit_cnt\(4))))) # (!\u1|bit_cnt\(3) & ((\u1|process_1~1_combout\) # ((\u1|bit_cnt\(4)))))
...
-- Equation(s):
-- \u1|tx_buf~6_combout\ = (\u1|tx_buf[7]~1_combout\ & (((\u1|tx_buf[7]~0_combout\)))) # (!\u1|tx_buf[7]~1_combout\ & ((\u1|tx_buf[7]~0_combout\ & (\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a5~portadataout\)) # (!\u1|tx_buf[7]~0_combout\ 
-- & ((reg_stbkcr(5))))))
...
PORT MAP (
	...
	datab => \u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a5~portadataout\,
...
-- Equation(s):
-- \u1|tx_buf~7_combout\ = (\u1|tx_buf[7]~1_combout\ & ((\u1|tx_buf~6_combout\ & ((\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a13~portadataout\))) # (!\u1|tx_buf~6_combout\ & (reg_stbycr(5))))) # (!\u1|tx_buf[7]~1_combout\ & 
-- (((\u1|tx_buf~6_combout\))))
...
-- Equation(s):
-- \u1|tx_buf~9_combout\ = (\u1|tx_buf[7]~0_combout\ & (((\u1|tx_buf[7]~1_combout\)))) # (!\u1|tx_buf[7]~0_combout\ & ((\u1|tx_buf[7]~1_combout\ & (reg_stbycr(4))) # (!\u1|tx_buf[7]~1_combout\ & ((reg_stbkcr(4))))))
...
-- Equation(s):
-- \u1|tx_buf~10_combout\ = (\u1|tx_buf[7]~0_combout\ & ((\u1|tx_buf~9_combout\ & ((\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a12~portadataout\))) # (!\u1|tx_buf~9_combout\ & 
-- (\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a4~portadataout\)))) # (!\u1|tx_buf[7]~0_combout\ & (((\u1|tx_buf~9_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a4~portadataout\,
	datab => \u1|tx_buf[7]~0_combout\,
	datac => \u1|tx_buf~9_combout\,
	datad => \u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a12~portadataout\,
...
-- Equation(s):
-- \u1|tx_buf~12_combout\ = (\u1|tx_buf[7]~1_combout\ & (((\u1|tx_buf[7]~0_combout\)))) # (!\u1|tx_buf[7]~1_combout\ & ((\u1|tx_buf[7]~0_combout\ & (\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a7~portadataout\)) # (!\u1|tx_buf[7]~0_combout\ 
-- & ((reg_stbkcr(7))))))
...
-- Equation(s):
-- \u1|tx_buf~13_combout\ = (\u1|tx_buf[7]~1_combout\ & ((\u1|tx_buf~12_combout\ & ((\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a15~portadataout\))) # (!\u1|tx_buf~12_combout\ & (reg_stbycr(7))))) # (!\u1|tx_buf[7]~1_combout\ & 
-- (((\u1|tx_buf~12_combout\))))
...
-- Equation(s):
-- \u1|tx_buf~15_combout\ = (\u1|tx_buf[7]~0_combout\ & (((\u1|tx_buf[7]~1_combout\)))) # (!\u1|tx_buf[7]~0_combout\ & ((\u1|tx_buf[7]~1_combout\ & (reg_stbycr(2))) # (!\u1|tx_buf[7]~1_combout\ & ((reg_stbkcr(2))))))
...
-- Equation(s):
-- \u1|tx_buf~16_combout\ = (\u1|tx_buf[7]~0_combout\ & ((\u1|tx_buf~15_combout\ & ((\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a10~portadataout\))) # (!\u1|tx_buf~15_combout\ & 
-- (\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a2~portadataout\)))) # (!\u1|tx_buf[7]~0_combout\ & (((\u1|tx_buf~15_combout\))))
...
PORT MAP (
	dataa => \u1|tx_buf[7]~1_combout\,
	datab => \u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a1~portadataout\,
	datac => \u1|tx_buf[7]~0_combout\,
	datad => reg_stbkcr(1),
...
-- Equation(s):
-- \u1|tx_buf~19_combout\ = (\u1|tx_buf[7]~1_combout\ & ((\u1|tx_buf~18_combout\ & ((\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a9~portadataout\))) # (!\u1|tx_buf~18_combout\ & (reg_stbycr(1))))) # (!\u1|tx_buf[7]~1_combout\ & 
-- (((\u1|tx_buf~18_combout\))))
...
PORT MAP (
	dataa => reg_stbycr(1),
	datab => \u1|tx_buf[7]~1_combout\,
	datac => \u1|tx_buf~18_combout\,
	datad => \u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a9~portadataout\,
...
-- Equation(s):
-- \u1|tx_buf~21_combout\ = (\u1|tx_buf[7]~0_combout\ & (((\u1|tx_buf[7]~1_combout\)))) # (!\u1|tx_buf[7]~0_combout\ & ((\u1|tx_buf[7]~1_combout\ & (reg_stbycr(0))) # (!\u1|tx_buf[7]~1_combout\ & ((reg_stbkcr(0))))))
...
-- Equation(s):
-- \u1|tx_buf~22_combout\ = (\u1|tx_buf[7]~0_combout\ & ((\u1|tx_buf~21_combout\ & ((\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a8~portadataout\))) # (!\u1|tx_buf~21_combout\ & 
-- (\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a0~portadataout\)))) # (!\u1|tx_buf[7]~0_combout\ & (((\u1|tx_buf~21_combout\))))
...
-- Equation(s):
-- \u1|tx_buf~25_combout\ = (\u1|tx_buf[7]~1_combout\ & ((\u1|tx_buf~24_combout\ & ((\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a11~portadataout\))) # (!\u1|tx_buf~24_combout\ & (reg_stbycr(3))))) # (!\u1|tx_buf[7]~1_combout\ & 
-- (((\u1|tx_buf~24_combout\))))
...
PORT MAP (
	...
	datad => \u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a11~portadataout\,
...
-- Equation(s):
-- \u1|s_wr_bank[0]~0_combout\ = (\u1|LessThan0~0_combout\ & (\u1|bit_cnt\(3) & (\u1|bit_cnt\(4) & !\u1|process_1~0_combout\)))
...
-- Equation(s):
-- \u1|s_wr_bank[5]~1_combout\ = (\u1|bit_cnt\(0) & (\u1|bit_cnt\(2) & (\u1|s_wr_bank[0]~0_combout\ & !\u1|bit_cnt\(1))))
...
-- Equation(s):
-- \u1|dpram_master|altsyncram_component|auto_generated|decode2|eq_node\(1) = (\u1|master_wren~q\ & \u1|s_wr_bank\(5))
...
-- Equation(s):
-- \Equal18~0_combout\ = (\led_latch[0]~1_combout\ & (addr_latch(1) & (addr_latch(4) & addr_latch(0))))
...
-- Equation(s):
-- \u1|s_wr_bank[0]~3_combout\ = (\u1|s_wr_bank[0]~0_combout\ & ((\u1|slave_ram_clk~0_combout\ & (\spi_mosi~input_o\)) # (!\u1|slave_ram_clk~0_combout\ & ((\u1|s_wr_bank\(0)))))) # (!\u1|s_wr_bank[0]~0_combout\ & (((\u1|s_wr_bank\(0)))))
...
-- Equation(s):
-- \u1|s_wr_bank[1]~4_combout\ = (\u1|bit_cnt\(0) & (\u1|s_wr_bank[0]~0_combout\ & (!\u1|bit_cnt\(1) & !\u1|bit_cnt\(2))))
...
PORT MAP (
	dataa => \u1|bit_cnt\(0),
	datab => \u1|s_wr_bank[0]~0_combout\,
	datac => \u1|bit_cnt\(1),
	datad => \u1|bit_cnt\(2),
...
PORT MAP (
	dataa => \spi_mosi~input_o\,
	datab => \u1|s_wr_bank\(1),
	datad => \u1|s_wr_bank[1]~4_combout\,
...
-- Equation(s):
-- \u1|s_wr_bank[2]~7_combout\ = (\u1|s_wr_bank[0]~0_combout\ & ((\u1|s_wr_bank[2]~6_combout\ & (\spi_mosi~input_o\)) # (!\u1|s_wr_bank[2]~6_combout\ & ((\u1|s_wr_bank\(2)))))) # (!\u1|s_wr_bank[0]~0_combout\ & (((\u1|s_wr_bank\(2)))))
...
-- Equation(s):
-- \u1|s_wr_bank[3]~9_combout\ = (\u1|s_wr_bank[0]~0_combout\ & ((\u1|s_wr_bank[3]~8_combout\ & (\spi_mosi~input_o\)) # (!\u1|s_wr_bank[3]~8_combout\ & ((\u1|s_wr_bank\(3)))))) # (!\u1|s_wr_bank[0]~0_combout\ & (((\u1|s_wr_bank\(3)))))
...
-- Equation(s):
-- \u1|s_wr_bank[4]~10_combout\ = (\u1|bit_cnt\(2) & (\u1|s_wr_bank[0]~0_combout\ & (!\u1|bit_cnt\(1) & !\u1|bit_cnt\(0))))
...
PORT MAP (
	dataa => \spi_mosi~input_o\,
	datab => \u1|s_wr_bank\(4),
	datad => \u1|s_wr_bank[4]~10_combout\,
...
-- Equation(s):
-- \data[6]~107_combout\ = (addr_latch(1) & (\Equal13~3_combout\ & (\dev_reg_act~q\ & addr_latch(4))))
...
-- Equation(s):
-- \data[6]~18_combout\ = (addr_latch(0) & (\Equal13~3_combout\ & (addr_latch(1) $ (addr_latch(4)))))
...
-- Equation(s):
-- \Equal20~0_combout\ = (\led_latch[0]~1_combout\ & (addr_latch(4) & (addr_latch(0) & !addr_latch(1))))
...
-- Equation(s):
-- \reg_fbs[0]~0_combout\ = (\reg_sdcr[0]~1_combout\ & \Equal20~0_combout\)
...
-- Equation(s):
-- \Equal17~0_combout\ = (addr_latch(0) & (\Equal13~3_combout\ & (!addr_latch(1) & !addr_latch(4))))
...
-- Equation(s):
-- \data[6]~20_combout\ = (!\Equal17~0_combout\ & (!\Equal18~0_combout\ & ((\Equal20~0_combout\) # (\Equal19~0_combout\))))
...
PORT MAP (
	dataa => reg_fbs(0),
	datab => reg_srbs(0),
	datac => \data[6]~20_combout\,
	datad => \data[0]~21_combout\,
	combout => \data[0]~22_combout\);

\data[0]~23\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \data[0]~23_combout\ = (\data[6]~18_combout\ & (reg_stbkcr(0) & (\data[6]~19_combout\))) # (!\data[6]~18_combout\ & (((!\data[6]~19_combout\ & \data[0]~22_combout\))))
...
PORT MAP (
	dataa => reg_stbkcr(0),
	datab => \data[6]~18_combout\,
	datac => \data[6]~19_combout\,
	datad => \data[0]~22_combout\,
	combout => \data[0]~23_combout\);

\data[6]~24\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \data[6]~24_combout\ = (\dev_reg_act~q\ & (((!\Equal13~4_combout\) # (!addr_latch(0))) # (!addr_latch(4))))
...
-- Equation(s):
-- \u1|dpram_master|altsyncram_component|auto_generated|decode2|eq_node\(0) = (\u1|master_wren~q\ & !\u1|s_wr_bank\(5))
...
-- Equation(s):
-- \u0|onchip_flash_0|avmm_data_controller|avmm_burstcount_reg[2]~13_combout\ = (\u0|onchip_flash_0|avmm_data_controller|avmm_burstcount_reg~7_combout\) # (((\u0|onchip_flash_0|avmm_data_controller|avmm_readdata_ready~q\ & 
-- !\u0|onchip_flash_0|avmm_data_controller|avmm_read_valid_state~q\)) # (!\u0|onchip_flash_0|avmm_data_controller|reset_n_reg2~q\))
...
-- !\u0|onchip_flash_0|avmm_data_controller|avmm_burstcount_reg[2]~13_combout\))
...
PORT MAP (
	...
	datad => \u0|onchip_flash_0|avmm_data_controller|avmm_burstcount_reg[2]~13_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \u0|onchip_flash_0|avmm_data_controller|read_drclk_en~q\,
	datab => \u0|onchip_flash_0|avmm_data_controller|read_state.READ_STATE_IDLE~q\,
...
PORT MAP (
	dataa => \u0|onchip_flash_0|avmm_data_controller|read_state.READ_STATE_READY~q\,
	datab => \u0|onchip_flash_0|avmm_data_controller|Selector7~1_combout\,
...
-- Equation(s):
-- \u0|onchip_flash_0|avmm_data_controller|flash_seq_read_ardin[12]~1_combout\ = (\u0|onchip_flash_0|avmm_data_controller|Add0~22_combout\ & ((\u0|onchip_flash_0|avmm_data_controller|Add0~16_combout\) # 
...
-- Equation(s):
-- \u0|onchip_flash_0|avmm_data_controller|Selector25~0_combout\ = (\u0|onchip_flash_0|avmm_data_controller|read_state.READ_STATE_SETUP~q\ & (((!\u0|onchip_flash_0|avmm_data_controller|flash_seq_read_ardin[12]~1_combout\) # 
...
-- Equation(s):
-- \u0|onchip_flash_0|avmm_data_controller|Selector26~1_combout\ = (\u0|onchip_flash_0|avmm_data_controller|read_state.READ_STATE_SETUP~q\ & (((\u0|onchip_flash_0|avmm_data_controller|Add0~24_combout\ & 
-- !\u0|onchip_flash_0|avmm_data_controller|Selector26~0_combout\)))) # (!\u0|onchip_flash_0|avmm_data_controller|read_state.READ_STATE_SETUP~q\ & (reg_fbs(4)))
...
PORT MAP (
	...
	datac => \u0|onchip_flash_0|avmm_data_controller|read_state.READ_STATE_SETUP~q\,
	datad => \u0|onchip_flash_0|avmm_data_controller|Selector26~0_combout\,
...
-- Equation(s):
-- \u0|onchip_flash_0|avmm_data_controller|Selector38~0_combout\ = (\u0|onchip_flash_0|avmm_data_controller|Add0~28_combout\) # ((\u0|onchip_flash_0|avmm_data_controller|Add0~24_combout\ & (\u0|onchip_flash_0|avmm_data_controller|Add0~26_combout\ & 
-- \u0|onchip_flash_0|avmm_data_controller|flash_seq_read_ardin[12]~1_combout\)))
...
PORT MAP (
	...
	datac => \u0|onchip_flash_0|avmm_data_controller|flash_seq_read_ardin[12]~1_combout\,
...
-- Equation(s):
-- \data[0]~27_combout\ = (addr_latch(1) & ((addr_latch(0) & ((!flash_data_latch(0)))) # (!addr_latch(0) & (!flash_data_latch(8))))) # (!addr_latch(1) & (((!addr_latch(0)))))
...
-- Equation(s):
-- \data[6]~33_combout\ = (\master_ram_en~q\ & (\u1|dpram_master|altsyncram_component|auto_generated|out_address_reg_b\(0) & !\dev_reg_act~q\))
...
-- Equation(s):
-- \u1|rx_buf[1]~6_combout\ = (\u1|bit_cnt\(0) & (\u1|rx_buf[7]~17_combout\ & (!\u1|bit_cnt\(1) & !\u1|bit_cnt\(2))))
...
-- Equation(s):
-- \data[1]~38_combout\ = (\data[6]~18_combout\ & (reg_stbkcr(1) & (\data[6]~19_combout\))) # (!\data[6]~18_combout\ & (((!\data[6]~19_combout\ & \data[1]~37_combout\))))
...
-- Equation(s):
-- \data[1]~40_combout\ = (addr_latch(0) & (((\data[1]~39_combout\)))) # (!addr_latch(0) & ((\data[1]~39_combout\ & ((!flash_data_latch(25)))) # (!\data[1]~39_combout\ & (!flash_data_latch(9)))))
...
PORT MAP (
	...
	datab => addr_latch(0),
	datac => \data[1]~39_combout\,
	datad => flash_data_latch(25),
	combout => \data[1]~40_combout\);

\data[1]~41\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \data[1]~41_combout\ = (\data[6]~26_combout\ & (((\data[6]~25_combout\)))) # (!\data[6]~26_combout\ & ((\data[6]~25_combout\ & (\u1|dpram_master|altsyncram_component|auto_generated|ram_block1a1~PORTBDATAOUT0\)) # (!\data[6]~25_combout\ & 
-- ((\data[1]~40_combout\)))))
...
PORT MAP (
	...
	datac => \data[6]~25_combout\,
	datad => \data[1]~40_combout\,
	combout => \data[1]~41_combout\);

\data[1]~42\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \data[1]~42_combout\ = (\data[6]~26_combout\ & ((\data[1]~41_combout\ & ((\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a9~PORTBDATAOUT0\))) # (!\data[1]~41_combout\ & 
-- (\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a1~PORTBDATAOUT0\)))) # (!\data[6]~26_combout\ & (((\data[1]~41_combout\))))
...
PORT MAP (
	...
	datab => \data[6]~26_combout\,
	datac => \data[1]~41_combout\,
...
-- Equation(s):
-- \data[1]~43_combout\ = (\data[6]~24_combout\ & (((\data[6]~107_combout\)))) # (!\data[6]~24_combout\ & ((\data[6]~107_combout\ & (reg_sdcr(1))) # (!\data[6]~107_combout\ & ((\data[1]~42_combout\)))))
...
-- Equation(s):
-- \data[1]~44_combout\ = (\data[6]~24_combout\ & ((\data[1]~43_combout\ & ((reg_stbycr(1)))) # (!\data[1]~43_combout\ & (\data[1]~38_combout\)))) # (!\data[6]~24_combout\ & (((\data[1]~43_combout\))))
...
PORT MAP (
	...
	datab => reg_srbs(2),
	datac => \data[6]~20_combout\,
	datad => \data[2]~46_combout\,
	combout => \data[2]~47_combout\);

\data[2]~48\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \data[2]~48_combout\ = (\data[6]~18_combout\ & (reg_stbkcr(2) & (\data[6]~19_combout\))) # (!\data[6]~18_combout\ & (((!\data[6]~19_combout\ & \data[2]~47_combout\))))
...
-- Equation(s):
-- \data[2]~49_combout\ = (addr_latch(1) & ((addr_latch(0) & ((!flash_data_latch(2)))) # (!addr_latch(0) & (!flash_data_latch(10))))) # (!addr_latch(1) & (((!addr_latch(0)))))
...
-- Equation(s):
-- \data[2]~50_combout\ = (addr_latch(1) & (((\data[2]~49_combout\)))) # (!addr_latch(1) & ((\data[2]~49_combout\ & ((!flash_data_latch(26)))) # (!\data[2]~49_combout\ & (!flash_data_latch(18)))))
...
-- Equation(s):
-- \data[2]~51_combout\ = (\data[6]~25_combout\ & (((\data[6]~26_combout\)))) # (!\data[6]~25_combout\ & ((\data[6]~26_combout\ & (\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a2~PORTBDATAOUT0\)) # (!\data[6]~26_combout\ & 
-- ((\data[2]~50_combout\)))))
...
-- Equation(s):
-- \data[2]~54_combout\ = (\data[6]~107_combout\ & ((\data[2]~53_combout\ & ((reg_stbycr(2)))) # (!\data[2]~53_combout\ & (reg_sdcr(2))))) # (!\data[6]~107_combout\ & (((\data[2]~53_combout\))))
...
-- Equation(s):
-- \data[3]~58_combout\ = (\data[6]~18_combout\ & (reg_stbkcr(3) & (\data[6]~19_combout\))) # (!\data[6]~18_combout\ & (((!\data[6]~19_combout\ & \data[3]~57_combout\))))
...
-- Equation(s):
-- \data[3]~61_combout\ = (\data[6]~26_combout\ & (((\data[6]~25_combout\)))) # (!\data[6]~26_combout\ & ((\data[6]~25_combout\ & (\u1|dpram_master|altsyncram_component|auto_generated|ram_block1a3~PORTBDATAOUT0\)) # (!\data[6]~25_combout\ & 
-- ((\data[3]~60_combout\)))))
...
-- Equation(s):
-- \data[3]~63_combout\ = (\data[6]~24_combout\ & (((\data[6]~107_combout\)))) # (!\data[6]~24_combout\ & ((\data[6]~107_combout\ & (reg_sdcr(3))) # (!\data[6]~107_combout\ & ((\data[3]~62_combout\)))))
...
PORT MAP (
	...
	datab => reg_sdcr(3),
	datac => \data[6]~107_combout\,
	datad => \data[3]~62_combout\,
	combout => \data[3]~63_combout\);

\data[3]~64\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \data[3]~64_combout\ = (\data[6]~24_combout\ & ((\data[3]~63_combout\ & ((reg_stbycr(3)))) # (!\data[3]~63_combout\ & (\data[3]~58_combout\)))) # (!\data[6]~24_combout\ & (((\data[3]~63_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \data[3]~58_combout\,
	datab => \data[6]~24_combout\,
	datac => \data[3]~63_combout\,
	datad => reg_stbycr(3),
...
-- Equation(s):
-- \u1|rx_buf[4]~10_combout\ = (\u1|bit_cnt\(2) & (\u1|rx_buf[7]~16_combout\ & (\u1|rx_buf[7]~4_combout\ & !\u1|bit_cnt\(0))))
...
PORT MAP (
	dataa => \u1|bit_cnt\(2),
	datab => \u1|rx_buf[7]~16_combout\,
	datac => \u1|rx_buf[7]~4_combout\,
	datad => \u1|bit_cnt\(0),
	combout => \u1|rx_buf[4]~10_combout\);

\u1|rx_buf[4]~11\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \u1|rx_buf[4]~11_combout\ = (\u1|rx_buf[4]~10_combout\ & ((\u1|bit_cnt\(1) & (\u1|rx_buf\(4))) # (!\u1|bit_cnt\(1) & ((\spi_mosi~input_o\))))) # (!\u1|rx_buf[4]~10_combout\ & (\u1|rx_buf\(4)))
...
PORT MAP (
	...
	datab => reg_srbs(4),
	datac => \data[6]~20_combout\,
	datad => \data[4]~66_combout\,
	combout => \data[4]~67_combout\);

\data[4]~68\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \data[4]~68_combout\ = (\data[6]~18_combout\ & (reg_stbkcr(4) & (\data[6]~19_combout\))) # (!\data[6]~18_combout\ & (((!\data[6]~19_combout\ & \data[4]~67_combout\))))
...
-- Equation(s):
-- \data[4]~69_combout\ = (addr_latch(1) & ((addr_latch(0) & ((!flash_data_latch(4)))) # (!addr_latch(0) & (!flash_data_latch(12))))) # (!addr_latch(1) & (((!addr_latch(0)))))
...
-- Equation(s):
-- \data[4]~71_combout\ = (\data[6]~25_combout\ & (((\data[6]~26_combout\)))) # (!\data[6]~25_combout\ & ((\data[6]~26_combout\ & (\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a4~PORTBDATAOUT0\)) # (!\data[6]~26_combout\ & 
-- ((\data[4]~70_combout\)))))
...
-- Equation(s):
-- \data[4]~73_combout\ = (\data[6]~107_combout\ & (((\data[6]~24_combout\)))) # (!\data[6]~107_combout\ & ((\data[6]~24_combout\ & (\data[4]~68_combout\)) # (!\data[6]~24_combout\ & ((\data[4]~72_combout\)))))
...
-- Equation(s):
-- \data[4]~74_combout\ = (\data[6]~107_combout\ & ((\data[4]~73_combout\ & ((reg_stbycr(4)))) # (!\data[4]~73_combout\ & (reg_sdcr(4))))) # (!\data[6]~107_combout\ & (((\data[4]~73_combout\))))
...
-- Equation(s):
-- \u1|rx_buf[5]~12_combout\ = (\u1|bit_cnt\(0) & (\u1|bit_cnt\(2) & (\u1|rx_buf[7]~17_combout\ & !\u1|bit_cnt\(1))))
...
PORT MAP (
	...
	datab => reg_srbs(5),
	datac => \data[6]~20_combout\,
	datad => \data[5]~76_combout\,
	combout => \data[5]~77_combout\);

\data[5]~78\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \data[5]~78_combout\ = (\data[6]~18_combout\ & (reg_stbkcr(5) & (\data[6]~19_combout\))) # (!\data[6]~18_combout\ & (((!\data[6]~19_combout\ & \data[5]~77_combout\))))
...
-- Equation(s):
-- \data[5]~81_combout\ = (\data[6]~26_combout\ & (((\data[6]~25_combout\)))) # (!\data[6]~26_combout\ & ((\data[6]~25_combout\ & (\u1|dpram_master|altsyncram_component|auto_generated|ram_block1a5~PORTBDATAOUT0\)) # (!\data[6]~25_combout\ & 
-- ((\data[5]~80_combout\)))))
...
-- Equation(s):
-- \data[5]~82_combout\ = (\data[6]~26_combout\ & ((\data[5]~81_combout\ & ((\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a13~PORTBDATAOUT0\))) # (!\data[5]~81_combout\ & 
-- (\u1|dpram_slave|altsyncram_component|auto_generated|ram_block1a5~PORTBDATAOUT0\)))) # (!\data[6]~26_combout\ & (((\data[5]~81_combout\))))
...
-- Equation(s):
-- \data[5]~83_combout\ = (\data[6]~24_combout\ & (((\data[6]~107_combout\)))) # (!\data[6]~24_combout\ & ((\data[6]~107_combout\ & (reg_sdcr(5))) # (!\data[6]~107_combout\ & ((\data[5]~82_combout\)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \data[5]~78_combout\,
	datab => \data[6]~24_combout\,
	datac => \data[5]~83_combout\,
	datad => reg_stbycr(5),
...
-- Equation(s):
-- \data[6]~88_combout\ = (\data[6]~18_combout\ & (reg_stbkcr(6) & (\data[6]~19_combout\))) # (!\data[6]~18_combout\ & (((!\data[6]~19_combout\ & \data[6]~87_combout\))))
...
-- Equation(s):
-- \data[6]~89_combout\ = (addr_latch(1) & ((addr_latch(0) & ((!flash_data_latch(6)))) # (!addr_latch(0) & (!flash_data_latch(14))))) # (!addr_latch(1) & (((!addr_latch(0)))))
...
-- Equation(s):
-- \data[6]~90_combout\ = (addr_latch(1) & (((\data[6]~89_combout\)))) # (!addr_latch(1) & ((\data[6]~89_combout\ & ((!flash_data_latch(30)))) # (!\data[6]~89_combout\ & (!flash_data_latch(22)))))
...
PORT MAP (
	dataa => \data[6]~107_combout\,
	datab => \data[6]~88_combout\,
	datac => \data[6]~24_combout\,
	datad => \data[6]~92_combout\,
	combout => \data[6]~93_combout\);

\data[6]~94\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \data[6]~94_combout\ = (\data[6]~107_combout\ & ((\data[6]~93_combout\ & ((reg_stbycr(6)))) # (!\data[6]~93_combout\ & (reg_sdcr(6))))) # (!\data[6]~107_combout\ & (((\data[6]~93_combout\))))
...
PORT MAP (
	...
	datab => \data[6]~94_combout\,
	datad => \data[6]~33_combout\,
	combout => \data[6]~95_combout\);

\u1|rx_buf[7]~15\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \u1|rx_buf[7]~15_combout\ = (\u1|master_ram_clk~1_combout\ & ((\u1|rx_buf[7]~17_combout\ & (\spi_mosi~input_o\)) # (!\u1|rx_buf[7]~17_combout\ & ((\u1|rx_buf\(7)))))) # (!\u1|master_ram_clk~1_combout\ & (((\u1|rx_buf\(7)))))
...
PORT MAP (
	dataa => \spi_mosi~input_o\,
	datab => \u1|rx_buf\(7),
	datac => \u1|master_ram_clk~1_combout\,
	datad => \u1|rx_buf[7]~17_combout\,
...
-- Equation(s):
-- \data[7]~99_combout\ = (\data[7]~96_combout\) # ((\data[7]~98_combout\ & (!\data[6]~18_combout\ & !\data[6]~19_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \data[7]~96_combout\,
	datab => \data[7]~98_combout\,
	datac => \data[6]~18_combout\,
	datad => \data[6]~19_combout\,
...
-- Equation(s):
-- \data[7]~101_combout\ = (addr_latch(0) & (((\data[7]~100_combout\)))) # (!addr_latch(0) & ((\data[7]~100_combout\ & ((!flash_data_latch(31)))) # (!\data[7]~100_combout\ & (!flash_data_latch(15)))))
...
-- Equation(s):
-- \data[7]~104_combout\ = (\data[6]~24_combout\ & (((\data[6]~107_combout\)))) # (!\data[6]~24_combout\ & ((\data[6]~107_combout\ & (reg_sdcr(7))) # (!\data[6]~107_combout\ & ((\data[7]~103_combout\)))))
...
-- Equation(s):
-- \data[7]~105_combout\ = (\data[6]~24_combout\ & ((\data[7]~104_combout\ & ((reg_stbycr(7)))) # (!\data[7]~104_combout\ & (\data[7]~99_combout\)))) # (!\data[6]~24_combout\ & (((\data[7]~104_combout\))))
...
PORT MAP (
	...
	datab => \data[7]~105_combout\,
	datad => \data[6]~33_combout\,
	combout => \data[7]~106_combout\);

\led_latch[0]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \led_latch[0]~2_combout\ = (addr_latch(1) & (addr_latch(0) & !addr_latch(4)))
...
-- Equation(s):
-- \led_latch[0]~3_combout\ = (\reg_sdcr[0]~1_combout\ & (\led_latch[0]~1_combout\ & \led_latch[0]~2_combout\))
...
-- Equation(s):
-- \data_dir~0_combout\ = ((\LessThan4~0_combout\ & (!\addr[11]~input_o\ & !\dev_reg_act~2_combout\))) # (!\Equal11~3_combout\)
...
-- Equation(s):
-- \data_dir~1_combout\ = (\rw~input_o\ & ((\Equal11~5_combout\) # ((!\data_dir~0_combout\ & \Equal10~5_combout\))))
